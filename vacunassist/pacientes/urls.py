...
urlpatterns = [
    ...
    path(
        'contraseña/',
        cambiarPassword.as_view(
            template_name = 'pacientes/cambiar-contraseña.html'
        )
    ),
    path(
    ...
    path(
        'mis_solicitudes/solicitud_fiebre_amarilla/',
        solicitud_fiebre_amarilla,
        name = "solicitud_fiebre_amarilla"
    ),
    path('inicio_pacientes/', inicio_pacientes, name = 'inicio_pacientes'),
    path(
        'mis_vacunas/descargar_comprobante/<int:vacuna_id>',
        descargar_comprobante.as_view(),
    ...
    path(
        ...
        restPasswordConfirm.as_view(
            template_name = 'pacientes/rest-contra-conf.html'
        ),
